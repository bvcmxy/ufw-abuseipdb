...
YOUR_API_KEY="511365556c5c8dea655522798784e4d2a90836a4c9024a7ea3f5109d4ab93515a4ae2c7eb041438e"
...
#check if file exist and contain data
if [[ -s $COMBINEDIPV6 ]] ; then
